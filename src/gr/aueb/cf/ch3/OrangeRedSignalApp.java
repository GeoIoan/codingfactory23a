 ...
 * Αν μια δεξαμενη έχει λιγοτερό απο
 * 1/4 καύσιμα τότε ανάβει πορτοκαλί σήμα,
 * ενώ αν και οι δύο δεξαμενές έχουν λιγότερο
 * απο 1/4 τότε ανάβει κόκκινο σήμα.
...
public class OrangeRedSignalApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Insert please if tank1, tank 2 are less than 1/4");
